...
class User: Codable {
    ...
    static let example = User(id: UUID(), isActive: true, name: "Marcin Frydrych", age: 43, company: "Apple", email: "marcinf23@gmail.com", address: "Toruń", about: "Taki sobie człek", registered: .now, tags: ["bla", "bla"], friends: [])
